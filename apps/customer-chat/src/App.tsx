...
const UI: Record<string, Record<string, string>> = {
  menu:        { it: 'Menu', en: 'Menu', de: 'Speisekarte', es: 'Carta', fr: 'Menu', pt: 'Menu', ru: 'Меню', zh: '菜单', ja: 'メニュー', ar: 'قائمة', ko: '메뉴', id: 'Menu', hi: 'मेन्यू' },
  assistant:   { it: 'Assistente', en: 'Assistant', de: 'Assistent', es: 'Asistente', fr: 'Assistant', pt: 'Assistente', ru: 'Ассистент', zh: '助手', ja: 'アシスタント', ar: 'مساعد', ko: '어시스턴트', id: 'Asisten', hi: 'सहायक' },
  write:       { it: 'Scrivi un messaggio...', en: 'Write a message...', de: 'Nachricht...', es: 'Escribe...', fr: 'Écris un message...', pt: 'Escreva...', ru: 'Написать...', zh: '输入消息...', ja: 'メッセージを入力...', ar: 'اكتب رسالة...', ko: '메시지를 입력하세요...', id: 'Tulis pesan...', hi: 'संदेश लिखें...' },
  listening:   { it: '🎤 Sto ascoltando...', en: '🎤 Listening...', de: '🎤 Ich höre zu...', es: '🎤 Escuchando...', fr: '🎤 J\'écoute...', pt: '🎤 Ouvindo...', ru: '🎤 Слушаю...', zh: '🎤 正在聆听...', ja: '🎤 聞いています...', ar: '🎤 أستمع...', ko: '🎤 듣고 있어요...', id: '🎤 Sedang mendengarkan...', hi: '🎤 सुन रहा हूं...' },
  confirm:     { it: '📋 Conferma ordine', en: '📋 Confirm order', de: '📋 Bestellung bestätigen', es: '📋 Confirmar pedido', fr: '📋 Confirmer la commande', pt: '📋 Confirmar pedido', ru: '📋 Подтвердить заказ', zh: '📋 确认订单', ja: '📋 注文確認', ar: '📋 تأكيد الطلب', ko: '📋 주문 확인', id: '📋 Konfirmasi pesanan', hi: '📋 ऑर्डर की पुष्टि करें' },
  modify:      { it: 'Modifica', en: 'Modify', de: 'Ändern', es: 'Modificar', fr: 'Modifier', pt: 'Modificar', ru: 'Изменить', zh: '修改', ja: '修正', ar: 'تعديل', ko: '수정', id: 'Ubah', hi: 'बदलें' },
  confirmBtn:  { it: 'Conferma ✓', en: 'Confirm ✓', de: 'Bestätigen ✓', es: 'Confirmar ✓', fr: 'Confirmer ✓', pt: 'Confirmar ✓', ru: 'Подтвердить ✓', zh: '确认 ✓', ja: '確認 ✓', ar: 'تأكيد ✓', ko: '확인 ✓', id: 'Konfirmasi ✓', hi: 'पुष्टि करें ✓' },
  ordered:     { it: '✓ Ordinato', en: '✓ Ordered', de: '✓ Bestellt', es: '✓ Pedido', fr: '✓ Commandé', pt: '✓ Pedido', ru: '✓ Заказано', zh: '✓ 已点', ja: '✓ 注文済', ar: '✓ تم الطلب', ko: '✓ 주문됨', id: '✓ Dipesan', hi: '✓ ऑर्डर किया गया' },
  orderOk:     { it: '✅ Ordine ricevuto! Buon appetito!', en: '✅ Order received! Enjoy!', de: '✅ Bestellung erhalten! Guten Appetit!', es: '✅ ¡Pedido recibido! ¡Que lo disfruten!', fr: '✅ Commande reçue ! Bon appétit !', pt: '✅ Pedido recebido! Bom apetite!', ru: '✅ Заказ принят! Приятного аппетита!', zh: '✅ 订单已收到！请慢用！', ja: '✅ ご注文を承りました！どうぞ！', ar: '✅ تم استلام طلبك! بالهناء!', ko: '✅ 주문이 접수되었어요! 맛있게 드세요!', id: '✅ Pesanan diterima! Selamat menikmati!', hi: '✅ ऑर्डर मिल गया! खाने का आनंद लें!' },
  askMarco:    { it: 'Chiedi a {n}', en: 'Ask {n}', de: '{n} fragen', es: 'Preguntar a {n}', fr: 'Demander à {n}', pt: 'Perguntar ao {n}', ru: 'Спросить {n}', zh: '询问{n}', ja: '{n}に聞く', ar: 'اسأل {n}', ko: '{n}에게 물어보기', id: 'Tanya {n}', hi: '{n} से पूछें' },
  addOrder:    { it: '📋 Aggiungi al promemoria', en: '📋 Add to my list', de: '📋 Zur Liste', es: '📋 Añadir a mi lista', fr: '📋 Ajouter à ma liste', pt: '📋 Adicionar à lista', ru: '📋 В список', zh: '📋 加入清单', ja: '📋 リストに追加', ar: '📋 أضف إلى قائمتي', ko: '📋 목록에 추가', id: '📋 Tambahkan ke daftar', hi: '📋 सूची में जोड़ें' },
  savedList:   { it: '📋 Da mostrare al cameriere', en: '📋 Show this to the waiter', de: '🍽️ Gemerkte Gerichte', es: '🍽️ Tus platos guardados', fr: '🍽️ Vos plats sauvegardés', pt: '🍽️ Os seus pratos guardados', ru: '🍽️ Сохранённые блюда', zh: '🍽️ 已保存的菜肴', ja: '🍽️ 保存した料理', ar: '🍽️ أطباقك المحفوظة', ko: '📋 웨이터에게 보여주세요', id: '📋 Tunjukkan ke pelayan', hi: '📋 वेटर को दिखाएं' },
  clearList:   { it: 'Svuota il promemoria', en: 'Clear the list', de: 'Liste leeren', es: 'Vaciar la lista', fr: 'Vider la liste', pt: 'Limpar a lista', ru: 'Очистить список', zh: '清空清单', ja: 'リストを空にする', ar: 'إفراغ القائمة', ko: '목록 비우기', id: 'Kosongkan daftar', hi: 'सूची खाली करें' },
  savedEmpty:  { it: 'Nessun piatto salvato', en: 'No saved dishes', de: 'Keine Gerichte gemerkt', es: 'Ningún plato guardado', fr: 'Aucun plat sauvegardé', pt: 'Nenhum prato guardado', ru: 'Нет сохранённых блюд', zh: '没有保存的菜肴', ja: '保存した料理はありません', ar: 'لا توجد أطباق محفوظة', ko: '저장된 메뉴가 없어요', id: 'Belum ada hidangan tersimpan', hi: 'कोई व्यंजन सहेजा नहीं गया' },
  savedNote:   { it: '⚠️ Il personale prenderà il tuo ordine al tavolo', en: '⚠️ Staff will take your order at the table', de: '⚠️ Das Personal nimmt Ihre Bestellung am Tisch auf', es: '⚠️ El personal tomará su pedido en la mesa', fr: '⚠️ Le personnel prendra votre commande à table', pt: '⚠️ O pessoal tomará o seu pedido na mesa', ru: '⚠️ Персонал примет ваш заказ за столом', zh: '⚠️ 服务员将在桌边为您点餐', ja: '⚠️ スタッフがテーブルでご注文を承ります', ar: '⚠️ سيأخذ الموظفون طلبك على الطاولة', ko: '⚠️ 직원이 테이블에서 주문을 받을 거예요', id: '⚠️ Staf akan mencatat pesanan Anda di meja', hi: '⚠️ स्टाफ आपकी टेबल पर आकर ऑर्डर लेगा' },
  total:       { it: 'Totale stimato', en: 'Estimated total', de: 'Geschätztes Gesamt', es: 'Total estimado', fr: 'Total estimé', pt: 'Total estimado', ru: 'Примерная сумма', zh: '预计总计', ja: '合計（目安）', ar: 'المجموع التقديري', ko: '예상 총액', id: 'Perkiraan total', hi: 'अनुमानित कुल राशि' },
  sharedTable: { it: 'Sessione tavolo condivisa', en: 'Shared table', de: 'Gemeinsamer Tisch', es: 'Mesa compartida', fr: 'Table partagée', pt: 'Mesa compartilhada', ru: 'Общий стол', zh: '共享桌台', ja: 'テーブル共有', ar: 'طاولة مشتركة', ko: '테이블 공유 세션', id: 'Sesi meja bersama', hi: 'साझा टेबल सत्र' },
  alreadyOrd:  { it: 'Già ordinato', en: 'Already ordered', de: 'Bereits bestellt', es: 'Ya pedido', fr: 'Déjà commandé', pt: 'Já pedido', ru: 'Уже заказано', zh: '已点', ja: '注文済み', ar: 'تم الطلب', ko: '이미 주문됨', id: 'Sudah dipesan', hi: 'पहले से ऑर्डर किया गया' },
  myDishes:    { it: 'Promemoria', en: 'My list', de: 'Meine Liste', es: 'Mi lista', fr: 'Ma liste', pt: 'A minha lista', ru: 'Мой список', zh: '我的清单', ja: '私のリスト', ar: 'قائمتي', ko: '내 목록', id: 'Daftar saya', hi: 'मेरी सूची' },
  remove:      { it: 'Rimuovi', en: 'Remove', de: 'Entfernen', es: 'Eliminar', fr: 'Supprimer', pt: 'Remover', ru: 'Удалить', zh: '删除', ja: '削除', ar: 'إزالة', ko: '삭제', id: 'Hapus', hi: 'हटाएं' },
  savedDish:   { it: '✓ Salvato', en: '✓ Saved', de: '✓ Gespeichert', es: '✓ Guardado', fr: '✓ Sauvegardé', pt: '✓ Guardado', ru: '✓ Сохранено', zh: '✓ 已保存', ja: '✓ 保存済み', ar: '✓ محفوظ', ko: '✓ 저장됨', id: '✓ Tersimpan', hi: '✓ सहेजा गया' },
  homeMenu:    { it: '🍽️ Menu', en: '🍽️ Menu', de: '🍽️ Speisekarte', es: '🍽️ Carta', fr: '🍽️ Menu', pt: '🍽️ Menu', ru: '🍽️ Меню', zh: '🍽️ 菜单', ja: '🍽️ メニュー', ar: '🍽️ قائمة', ko: '🍽️ 메뉴', id: '🍽️ Menu', hi: '🍽️ मेन्यू' },
  homeAllergy: { it: '⚠️ Allergie o Intolleranze', en: '⚠️ Allergies & Intolerances', de: '⚠️ Allergien & Unverträglichkeiten', es: '⚠️ Alergias e Intolerancias', fr: '⚠️ Allergies & Intolérances', pt: '⚠️ Alergias & Intolerâncias', ru: '⚠️ Аллергии и непереносимость', zh: '⚠️ 过敏与不耐受', ja: '⚠️ アレルギーと不耐性', ar: '⚠️ الحساسية وعدم التحمل', ko: '⚠️ 알레르기 및 못 먹는 음식', id: '⚠️ Alergi & Intoleransi', hi: '⚠️ एलर्जी और असहनशीलता' },
  homeAI:      { it: '💬 Assistente AI', en: '💬 AI Assistant', de: '💬 KI-Assistent', es: '💬 Asistente IA', fr: '💬 Assistant IA', pt: '💬 Assistente IA', ru: '💬 ИИ-Ассистент', zh: '💬 AI助手', ja: '💬 AIアシスタント', ar: '💬 المساعد الذكي', ko: '💬 AI 어시스턴트', id: '💬 Asisten AI', hi: '💬 AI सहायक' },
  allergyMsg:  { it: 'Ho un\'allergia o intolleranza alimentare, puoi aiutarmi?', en: 'I have a food allergy or intolerance, can you help me?', de: 'Ich habe eine Lebensmittelallergie, können Sie mir helfen?', es: 'Tengo una alergia alimentaria, ¿puedes ayudarme?', fr: 'J\'ai une allergie alimentaire, pouvez-vous m\'aider?', pt: 'Tenho uma alergia alimentar, pode ajudar-me?', ru: 'У меня пищевая аллергия, можете помочь?', zh: '我有食物过敏，能帮助我吗？', ja: '食物アレルギーがあります、助けてもらえますか？', ar: 'لدي حساسية غذائية، هل يمكنك مساعدتي؟', ko: '음식 알레르기나 못 먹는 음식이 있어요, 도와주실 수 있나요?', id: 'Saya punya alergi atau intoleransi makanan, bisakah Anda membantu saya?', hi: 'मुझे खाने से जुड़ी एलर्जी या असहनशीलता है, क्या आप मेरी मदद कर सकते हैं?' },
